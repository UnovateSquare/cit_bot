...
module.exports = class Rank extends Command {
    ...
    await i.deferReply()
      ...
      registerFont('Bot/Structure/Images/integralcf.ttf', { family: "Integral CF Heavy"});
...
// Back of the back
const backgroundofthebackground = await loadImage(resolve("Bot/Structure/Images/rankcard/backoftheback.png"))
...
my_gradient.addColorStop(0, "#fff");
  ...
  ctx.beginPath();
  ctx.roundRect(621, 273, barWidth, 121, [0, 57, 57, 0])
  ctx.fill()


   // Back 
   const background = await loadImage(resolve("Bot/Structure/Images/rankcard/rankcard.png"))
