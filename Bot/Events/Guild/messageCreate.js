...
module.exports = class {
	...
	async run (message, client) {
        ...
        // console.log(gset)
         ...
         if (["discordapp.com/invite/", "discord.gg/", "https://"].includes(message.content) && !message.member.permissions.has(Discord.PermissionsBitField.Flags.ManageGuild)) return message.delete().catch(() => {})
    ...
    //    console.log(UserLevel)
        ...
        await db.set(`level_${message.guild.id}_${message.author.id}.messages`, UserLevel.messages + 1)
            ...
            if(UserLevel.xp >= xpNeeded) {
                ...
                let  messageLevelUp = "Félicitations {user.mention}, tu viens de passer au niveau {level} !" 
